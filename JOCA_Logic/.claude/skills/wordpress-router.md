...
description: "The user asks about WordPress codebases (plugins, themes, block themes, Gutenberg blocks, WP core checkouts) and you need to quickly classify the repo and route to the correct. MUST be invoked when the user mentions: WordPress, Gutenberg, WP, REST API, CLI."
