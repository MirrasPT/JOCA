...
| Skill | Descrição | Repo | Autor |
|-------|-----------|------|-------|
| frontend-design | Interfaces web production-grade, polidas, sem estética AI genérica | [anthropics/skills](https://github.com/anthropics/skills/tree/main/skills/frontend-design) | Anthropic |
| huashu-design | Protótipos HTML hi-fi, slides, animações, app mockups; design advisor + review 5D | [alchaincyf/huashu-design](https://github.com/alchaincyf/huashu-design) | alchaincyf |
...
| Skill | Descrição | Repo | Autor |
|-------|-----------|------|-------|
| laravel-specialist | Laravel 10+: Eloquent, Sanctum, Horizon, Livewire, API Resources, Pest/PHPUnit | [Jeffallan/claude-skills](https://github.com/Jeffallan/claude-skills) | Jeff Allan |
| php-pro | PHP 8.3+: strict typing, PHPStan L9, DTOs, async Swoole, PSR standards | [Jeffallan/claude-skills](https://github.com/Jeffallan/claude-skills) | Jeff Allan |
| postgres-pro | PostgreSQL: EXPLAIN, JSONB, replication, VACUUM, performance tuning | [Jeffallan/claude-skills](https://github.com/Jeffallan/claude-skills) | Jeff Allan |
| api-designer | REST/GraphQL API design: OpenAPI, versioning, pagination, error handling | [Jeffallan/claude-skills](https://github.com/Jeffallan/claude-skills) | Jeff Allan |
| devops-engineer | CI/CD, Docker, Kubernetes, Terraform, GitHub Actions, GitOps | [Jeffallan/claude-skills](https://github.com/Jeffallan/claude-skills) | Jeff Allan |
