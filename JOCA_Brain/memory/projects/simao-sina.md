...
- **TikTok (CONFIRMADO bloqueado):** todos os ~18 TikToks agendados vão falhar como o de 27 Jun (app não-auditada). **Acção:** auditar a app TikTok (Content Posting API → Direct Post) OU publicar manualmente na app. Até lá, só IG sai por TryPost. Ver secção "Distribuição agendada via TryPost".
