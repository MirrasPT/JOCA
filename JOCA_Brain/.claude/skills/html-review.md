---
name: html-review
description: "Converting markdown documentation to visual HTML format for review or presentation. MUST be invoked when the user says: generate html, review html, prd html, html review, view document, plan preview, export html, document for review. SHOULD also invoke when: pretty html, render markdown, show document."
triggers: generate html, review html, prd html, html review, view document, plan preview, export html, document for review, pretty html, render markdown, show document
---
...
```
Which document do you want in HTML?
1. PRD
2. Tech Spec
3. Tasks
4. All documents (bundle)
```
...
# Read the .md, generate HTML directly with the Write tool
```
...
<body>
  <div class="container">
    <div class="header">
      ...
      <h1>{{TITLE}}</h1>
      <div class="meta">Generated on {{DATE}} &middot; Source: <code>{{SOURCE_FILE}}</code></div>
    </div>
    <nav class="toc">
      <h2>Contents</h2>
      {{TOC}}
    ...
    <div class="footer">
      Review document generated by JOCA &middot; Source of truth: <code>{{SOURCE_FILE}}</code>
    </div>
  </div>
</body>
</html>
...
Notify: "Document generated. Want HTML for review?"
