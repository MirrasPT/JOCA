...
content-hash: 42f511dde49fa830
---

# tailwind — execution agent

tailwind specialist. Runs in its own context so the orchestrator can dispatch several jobs at
...
```
Read(".claude/skills/tailwind.md")
```
