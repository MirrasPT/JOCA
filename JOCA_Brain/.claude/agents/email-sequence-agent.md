...
content-hash: dbc7f61c8d036c3a
---

# email-sequence — execution agent

email-sequence specialist. Runs in its own context so the orchestrator can dispatch several jobs at
...
```
Read(".claude/skills/email-sequence.md")
```
