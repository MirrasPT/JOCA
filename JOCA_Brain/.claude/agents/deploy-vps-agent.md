...
description: "deploy · Deploy static sites or apps to a fresh Linux VPS using Caddy reverse proxy and Cloudflare DNS. Despachar para trabalho isolável deste domínio, em paralelo."
skills: deploy-vps
model: inherit
category: deploy
triggers: deploy VPS, VPS setup, Caddy, Caddy server, SSH key VPS, Cloudflare DNS API
generated-from: .claude/skills/deploy-vps.md
generated-by: skill-agents.mjs
content-hash: 829e74b4a086f74b
---
...
**Gatilhos:** deploy VPS, VPS setup, Caddy, Caddy server, SSH key VPS, Cloudflare DNS API, scp site, static site VPS, fresh Ubuntu server, bootstrap SSH, plink fingerprint, ED25519 key, /var/www, publicar VPS, configurar servidor, caddy vhost, static hosting

## Step 0 — obrigatório, antes de qualquer acção

```
Read(".claude/skills/deploy-vps.md")
```
