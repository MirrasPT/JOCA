...
content-hash: d49f85a49ac2d2ef
---

# laravel-react — execution agent

laravel-react specialist. Runs in its own context so the orchestrator can dispatch several jobs at
