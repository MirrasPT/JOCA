...
Especialista em stop-slop. Corre em contexto próprio para que o orquestrador possa despachar
vários trabalhos ao mesmo tempo sem bloquear a conversa principal.

**Gatilhos:** stop slop, AI slop, soa a AI, parece AI, escrito por AI, tells de AI, limpar escrita, soa a robo, soa a robô, polir copy, polir texto, remover padroes AI, remover padrões AI, prose slop, sounds AI, de-slop, deslop, anti-slop

## Step 0 — obrigatório, antes de qualquer acção

```
Read(".claude/skills/stop-slop.md")
```
