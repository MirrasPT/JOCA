...
content-hash: d23c8e3c8b7055e3
---

# shopify-app — execution agent

shopify-app specialist. Runs in its own context so the orchestrator can dispatch several jobs at
...
```
Read(".claude/skills/shopify-app.md")
```
