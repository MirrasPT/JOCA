...
content-hash: 15d8f0ccff4c69f3
---

# blender-scripting — execution agent

blender-scripting specialist. Runs in its own context so the orchestrator can dispatch several jobs at
