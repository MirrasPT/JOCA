---
name: automations-agent
description: "código · Traduzir pedido em linguagem natural numa automacao cron estruturada (QUANDO + O-QUE + REPORTAR) e. Despachar para trabalho isolável deste domínio, em paralelo."
skills: automations
model: inherit
category: código
triggers: automacao, automatizar, cron, agendar tarefa, todos os dias as, a cada X horas
generated-from: .claude/skills/automations.md
generated-by: skill-agents.mjs
content-hash: 25614973dc463d44
---

# automations — agente de execução

Especialista em automations. Corre em contexto próprio para que o orquestrador possa despachar
