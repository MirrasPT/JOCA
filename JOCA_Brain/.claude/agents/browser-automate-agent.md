...
content-hash: 4770cf96c2fd7919
---

# browser-automate — execution agent

browser-automate specialist. Runs in its own context so the orchestrator can dispatch several jobs at
...
```
Read(".claude/skills/browser-automate.md")
```
