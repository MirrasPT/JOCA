...
content-hash: 685f5221b0ae4882
---

# shopify-store-fixer — execution agent

shopify-store-fixer specialist. Runs in its own context so the orchestrator can dispatch several jobs at
...
```
Read(".claude/skills/shopify-store-fixer.md")
```
