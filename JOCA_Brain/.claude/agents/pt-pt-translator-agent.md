...
content-hash: afa7c816e69c6a32
---

# pt-pt-translator — execution agent

pt-pt-translator specialist. Runs in its own context so the orchestrator can dispatch several jobs at
...
```
Read(".claude/skills/pt-pt-translator.md")
```
