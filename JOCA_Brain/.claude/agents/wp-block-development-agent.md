...
content-hash: 1c5814cc0609a4d0
---

# wp-block-development — execution agent

wp-block-development specialist. Runs in its own context so the orchestrator can dispatch several jobs at
...
```
Read(".claude/skills/wp-block-development.md")
```
