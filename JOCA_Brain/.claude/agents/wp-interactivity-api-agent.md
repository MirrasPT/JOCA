...
content-hash: a219d6985a748236
---

# wp-interactivity-api — execution agent

wp-interactivity-api specialist. Runs in its own context so the orchestrator can dispatch several jobs at
...
```
Read(".claude/skills/wp-interactivity-api.md")
```
