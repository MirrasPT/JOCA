...
content-hash: 9ce08d45bf1fc79c
---

# transactional-email — execution agent

transactional-email specialist. Runs in its own context so the orchestrator can dispatch several jobs at
...
```
Read(".claude/skills/transactional-email.md")
```
