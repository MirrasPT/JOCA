...
content-hash: 18bb9753dca686fb
---

# saas-patterns — execution agent

saas-patterns specialist. Runs in its own context so the orchestrator can dispatch several jobs at
...
```
Read(".claude/skills/saas-patterns.md")
```
