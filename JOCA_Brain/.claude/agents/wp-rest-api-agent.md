...
content-hash: 12e240dd51fd9ccd
---

# wp-rest-api — execution agent

wp-rest-api specialist. Runs in its own context so the orchestrator can dispatch several jobs at
...
```
Read(".claude/skills/wp-rest-api.md")
```
