---
name: img-gen-agent
description: "design · Route and generate images via Codex CLI (OpenAI gpt-image-2) or Antigravity CLI (Gemini). Despachar para trabalho isolável deste domínio, em paralelo."
skills: img-gen
model: inherit
category: design
...
content-hash: 5282698110d33156
---

# img-gen — agente de execução

Especialista em img-gen. Corre em contexto próprio para que o orquestrador possa despachar
