...
content-hash: 6ed6a59dc3aae025
---

# design-shotgun — execution agent

design-shotgun specialist. Runs in its own context so the orchestrator can dispatch several jobs at
