...
content-hash: b57d706aad9a667f
---

# wp-block-themes — execution agent

wp-block-themes specialist. Runs in its own context so the orchestrator can dispatch several jobs at
...
```
Read(".claude/skills/wp-block-themes.md")
```
