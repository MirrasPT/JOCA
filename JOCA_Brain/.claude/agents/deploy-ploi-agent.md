...
content-hash: b28c95aa341c5655
---

# deploy-ploi — execution agent

deploy-ploi specialist. Runs in its own context so the orchestrator can dispatch several jobs at
...
```
Read(".claude/skills/deploy-ploi.md")
```
