...
content-hash: b62d730e25be8d54
---

# blender-render — execution agent

blender-render specialist. Runs in its own context so the orchestrator can dispatch several jobs at
