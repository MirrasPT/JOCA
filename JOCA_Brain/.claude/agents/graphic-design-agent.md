...
content-hash: d83cd15442761177
---

# graphic-design — execution agent

graphic-design specialist. Runs in its own context so the orchestrator can dispatch several jobs at
...
```
Read(".claude/skills/graphic-design.md")
```
