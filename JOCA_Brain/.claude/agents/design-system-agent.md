...
description: "design · Building or auditing design systems, managing design tokens, component libraries, or style guides. Despachar para trabalho isolável deste domínio, em paralelo."
skills: design-system
model: inherit
category: design
triggers: design system, sistema de design, tokens, design tokens, component system, sistema de componentes
generated-from: .claude/skills/design-system.md
generated-by: skill-agents.mjs
content-hash: 63eee69e6b65c037
---
...
**Gatilhos:** design system, sistema de design, tokens, design tokens, component system, sistema de componentes, visual system, sistema visual, UI system, criar design system, setup design, design setup, design foundation, fundacao visual
