...
content-hash: 6d38cdd5d7ff51a4
---

# social-content — execution agent

social-content specialist. Runs in its own context so the orchestrator can dispatch several jobs at
...
```
Read(".claude/skills/social-content.md")
```
