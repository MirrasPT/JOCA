...
description: "plataformas · Building or customising a Shopify theme: Liquid templating, theme architecture. Despachar para trabalho isolável deste domínio, em paralelo."
...
content-hash: 08f78ebc11b71e7b
---

# shopify-theme — agente de execução

Especialista em shopify-theme. Corre em contexto próprio para que o orquestrador possa despachar
...
```
Read(".claude/skills/shopify-theme.md")
```
