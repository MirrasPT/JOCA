...
content-hash: e7580fc0493e4463
---

# deploy-docker — execution agent

deploy-docker specialist. Runs in its own context so the orchestrator can dispatch several jobs at
