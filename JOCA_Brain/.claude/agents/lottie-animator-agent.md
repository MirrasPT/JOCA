...
description: "design · Generates professional Lottie animations from static SVGs. Despachar para trabalho isolável deste domínio, em paralelo."
...
content-hash: cff54ba7ff6cc03e
---

# lottie-animator — agente de execução

Especialista em lottie-animator. Corre em contexto próprio para que o orquestrador possa despachar
...
```
Read(".claude/skills/lottie-animator.md")
```
