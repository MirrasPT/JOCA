...
- **2.0**: The skill teaches Claude something it wouldn't do by default. It adds domain knowledge, workflow structure, or specialized behavior that's genuinely valuable. Someone using this skill produces significantly better output than without it.
