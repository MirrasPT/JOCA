...
content-hash: d51588d7543c7374
---

# wp-plugin-development — execution agent

wp-plugin-development specialist. Runs in its own context so the orchestrator can dispatch several jobs at
...
```
Read(".claude/skills/wp-plugin-development.md")
```
