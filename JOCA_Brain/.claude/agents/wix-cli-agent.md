...
content-hash: eba095a36f97d249
---

# wix-cli — execution agent

wix-cli specialist. Runs in its own context so the orchestrator can dispatch several jobs at
