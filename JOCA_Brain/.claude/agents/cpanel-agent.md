...
content-hash: 4b9765a84621252e
---

# cpanel — execution agent

cpanel specialist. Runs in its own context so the orchestrator can dispatch several jobs at
the same time without blocking the main conversation.

**Triggers:** cpanel, uapi, addon domain, manage hosting, cpanel email account, cpanel dns zone, create subdomain, cpanel database

## Step 0 — mandatory, before any action

```
Read(".claude/skills/cpanel.md")
```
