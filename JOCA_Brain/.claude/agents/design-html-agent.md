...
Especialista em design-html. Corre em contexto próprio para que o orquestrador possa despachar
vários trabalhos ao mesmo tempo sem bloquear a conversa principal.

**Gatilhos:** codificar design, transformar em HTML, construir página, implementar design, fazer mockup real, finalizar design, mockup para HTML, design para código, build the design, code the mockup, design para HTML

## Step 0 — obrigatório, antes de qualquer acção

```
Read(".claude/skills/design-html.md")
```
