...
content-hash: a09979831ecb78a0
---

# design-html — execution agent

design-html specialist. Runs in its own context so the orchestrator can dispatch several jobs at
