---
name: wpds-agent
description: "wordpress · Build UI with the WordPress Design System via the WPDS MCP — components, tokens, patterns. Despachar para trabalho isolável deste domínio, em paralelo."
skills: wpds
model: inherit
category: wordpress
...
content-hash: 5c86555daee6fe10
---

# wpds — agente de execução

Especialista em wpds. Corre em contexto próprio para que o orquestrador possa despachar
