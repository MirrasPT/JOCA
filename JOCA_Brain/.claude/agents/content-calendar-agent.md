...
content-hash: 79ea4169943571c1
---

# content-calendar — execution agent

content-calendar specialist. Runs in its own context so the orchestrator can dispatch several jobs at
...
```
Read(".claude/skills/content-calendar.md")
```
