...
autoplan · PRD → prod · Design (variants → production) · New UI · Frontend production · Laravel feature · Filament admin · API design · Backend hardening · Full-stack e-commerce · Debug · QA loop · Ship · CSO security · Deploy · Repair PR · Retro · New product (0 → production) · New screen in an existing project · Backlog → plan · Knowledge ingest · Market/recency research · Self-improvement.

⚠ Task matches one → `Read(".claude/reference/pipelines-catalog.md")` before the first step.
