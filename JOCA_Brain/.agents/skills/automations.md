...
### Resumo do dia — todos os dias as 18h, JOCA_UI
...
- **Daemon/scheduler** — corre em background com JOCA_UI fechado? Servico? PENDENTE na FUTUROS Fase 3. Esta skill nao decide isso.
