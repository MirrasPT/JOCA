# Livro de Elogios — arranque da plataforma dev + banner final do email do plano

TAGS: livro-de-elogios, joca, workers, email-banner, laravel, vite
JANELA: win-192 (8 turnos)
