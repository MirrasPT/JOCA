---
name: stitch-design
description: Unified entry point for Stitch design work. Handles prompt enhancement (UI/UX keywords, atmosphere), design system synthesis (.stitch/DESIGN.md), and high-fidelity screen generation/editing via Stitch MCP. Use when the user wants to create, edit, or refine UI designs using the Google Stitch MCP server.
allowed-tools:
  - "StitchMCP"
  - "Read"
  - "Write"
