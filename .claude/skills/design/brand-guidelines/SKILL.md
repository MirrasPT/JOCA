...
Geras um documento de sistema de marca completo e metódico. Output: `DESIGN.md` + `BRAND.md` — ficheiros que alimentam directamente as skills `frontend-design`, `frontend-dev`, e `slides`.
...
|-------|---------------------|
| `frontend-design` | Ler no início — cores, fontes, assets |
| `frontend-dev` | Extrair → Tailwind config + CSS variables |
