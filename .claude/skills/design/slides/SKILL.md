---
name: slides
description: HTML/CSS/JS presentation and pitch deck designer. Anti-slop, DESIGN.md integration, junior mode, 3 aesthetic variants. Outputs 1920×1080 HTML decks with keyboard navigation. Exports to PDF and editable PPTX on request. /export-pdf command for quick PDF export. For web components/UI → frontend-design. For video/animation export → video skill.
...
Igual ao `frontend-design` skill rule #0.
...
- `frontend-design` — protótipos web, UI, app mockups
