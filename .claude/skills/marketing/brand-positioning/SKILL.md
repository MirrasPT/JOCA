...
Run a web search for `'[Company/category] competitors alternatives 2026'` if competitor names aren't already known.
...
- **copywriting**: To translate positioning into landing page copy
- **page-cro**: To test if current website reflects this positioning
- **content-strategy**: To build content around this ICP and differentiator
- **competitor-profiling**: For deeper competitive intelligence
- **brand-guidelines**: For visual identity and tone of voice (in design/)
