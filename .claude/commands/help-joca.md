...
- Skills GSAP, Stitch, browser-use, ComfyUI, hyperframes: agrupar como bloco "GSAP (8)", "Stitch (8)", etc. com nota "(ver INDEX.md para lista completa)" para não poluir o output
